...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        // Use Stack to layer background image and content
        children: [
          // Background Image
          Positioned.fill(
            child: Image.asset(
              '157835-white-background.jpg', // Replace with your background image URL
              fit: BoxFit.cover, // Cover the entire screen
              errorBuilder: (context, error, stackTrace) => Container(
                color: Colors.blueGrey[50], // Fallback background color
          ...
          Center(
            child: Container(
              ...
              child: Column(
                mainAxisSize:
                    MainAxisSize.min, // Keep column size to its children
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  // Image for the splash screen (logo)
                  Image.asset(
                    'affinidi.png', // Placeholder image URL
